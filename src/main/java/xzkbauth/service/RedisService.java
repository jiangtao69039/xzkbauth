...
public interface RedisService {
     ...
     * @return
     */
    boolean set(final String key, Object value, int expireTime);
    /**
     * 批量删除对应的value
     * @param keys
     */
    ...
    void resetExpireTime(String key, int expireTime);
     ...
     * @param value
     * @param period
     * @param unit  0-天 1-时 2-分 3-秒 4-毫秒
     * @return
     */
    boolean setExpireTimeByUnit(final String key, Object value, int period, int unit);
